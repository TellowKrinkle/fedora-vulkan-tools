...
Patch:          valijson_thirdparty_cleanup.patch

# Build only i386, since that's what's excluded from the main Fedora repos
# Fedora 41 doesn't have valijson so we'll have to do this exclude manually
# ExcludeArch:    aarch64 ppc64le s390x x86_64
